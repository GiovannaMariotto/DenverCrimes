...
public class FXMLController {
    ...
    void doCalcolaPercorso(ActionEvent event) {
    	...
    	List<String> percorso =  new ArrayList(this.model.trovaPercorso(arco.getV1(), arco.getV2()));
    	txtResult.appendText("PERCORSO TRA "+arco.getV1().toUpperCase()+"  E  "+arco.getV2().toUpperCase()+"\n");
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	//Riempio la terndina per il punto 2
